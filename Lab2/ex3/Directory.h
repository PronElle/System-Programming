...
class Directory : public Base {
    ...
    explicit Directory(const std::string &_name);
...
public :
    ...
    static std::shared_ptr<Directory> makeDirectory(const std::string &_name, std::weak_ptr<Directory> parent);
    std::shared_ptr<Directory> addDirectory(const std::string &_name);
    static std::shared_ptr<Directory> getRoot();
    std::shared_ptr<File> addFile(const std::string &nome, uintmax_t size);

    // getters
    std::shared_ptr<Base> get(const std::string &_name);
    std::shared_ptr<Directory> getDir(const std::string &_name);
    std::shared_ptr<File> getFile(const std::string &_name);
